...
export default function Level12Games({ gameNumber, onComplete }: Level12GamesProps) {
  const [selectedAnswer, setSelectedAnswer] = useState<number | null>(null)

  const games = [
    {
      title: "¡Tesoros de la Pirámide!",
      instruction: "¿Cuántos tesoros hay en la pirámide?",
      items: [
        "💎",
        "💎",
        "💎",
    ...
    {
      title: "Objetos Egipcios",
      instruction: "¡Encuentra el objeto que no es egipcio!",
      items: ["🏺", "🐪", "🚀", "💎"],
      correctAnswer: 2,
      options: [0, 1, 2, 3],
    },
    {
      ...
      instruction: "¡Toca el símbolo diferente!",
      items: ["🏺", "🏺", "🎾", "🏺"],
      correctAnswer: 2,
      options: [0, 1, 2, 3],
    },
    {
      title: "Suma de Momias",
      instruction: "¿Cuántas momias descansan en la pirámide?",
      items: [
        "🧟",
        "🧟",
        "🧟",
    ...
    {
      title: "Patrón Egipcio",
      instruction: "¿Qué sigue en el patrón de la pirámide?",
      items: ["🏺", "💎", "🏺", "💎", "🏺", "?"],
      correctAnswer: 1,
      options: [0, 1, 2],
    },
    ...
    <Card className="w-full bg-white/90 backdrop-blur-sm">
      <CardContent className="p-8">
        <div className="text-center space-y-6">
          <h2 className="text-3xl font-bold text-amber-600 mb-4">{currentGame.title}</h2>
