...
export default function Level5Games({ gameNumber, onComplete }: Level5GamesProps) {
  const [selectedAnswer, setSelectedAnswer] = useState<number | null>(null)

  const games = [
    {
      title: "¡Camellos en el Desierto!",
      instruction: "¿Cuántos camellos caminan por la arena?",
      items: ["🐪", "🐪", "🐪", "🐪", "🐪", "🐪", "🐪", "🐪", "🐪", "🐪"],
      correctAnswer: 10,
      options: [9, 10, 11],
    },
    {
      title: "Criaturas del Desierto",
      instruction: "¡Encuentra el animal que no vive en el desierto!",
      items: ["🦎", "🐪", "🐧", "🦂"],
      correctAnswer: 2,
      options: [0, 1, 2, 3],
    },
    {
      title: "Cactus Especiales",
      instruction: "¡Toca el cactus diferente!",
      items: ["🌵", "🌵", "🌴", "🌵"],
      correctAnswer: 2,
      options: [0, 1, 2, 3],
    },
    {
      title: "Suma de Escorpiones",
      instruction: "¿Cuántos escorpiones hay en la arena?",
      items: ["🦂", "🦂", "🦂", "🦂", "🦂", "🦂", "🦂", "🦂", "🦂", "🦂", "🦂"],
      correctAnswer: 11,
      options: [10, 11, 12],
    },
    {
      ...
      instruction: "¿Qué sigue en el patrón del oasis?",
      items: ["🌵", "🐪", "🌵", "🐪", "🌵", "?"],
      correctAnswer: 1,
      options: [0, 1, 2],
    },
    ...
    <Card className="w-full bg-white/90 backdrop-blur-sm">
      <CardContent className="p-8">
        <div className="text-center space-y-6">
          <h2 className="text-3xl font-bold text-yellow-600 mb-4">{currentGame.title}</h2>
