...
interface Level6GamesProps {
  gameNumber: number
  onComplete: (isCorrect: boolean) => void
}

export default function Level6Games({ gameNumber, onComplete }: Level6GamesProps) {
  const [selectedAnswer, setSelectedAnswer] = useState<number | null>(null)

  const games = [
    {
      title: "¡Autos en la Ciudad!",
      instruction: "¿Cuántos autos circulan por la ciudad?",
      items: ["🚗", "🚗", "🚗", "🚗", "🚗", "🚗", "🚗", "🚗", "🚗", "🚗", "🚗", "🚗"],
      correctAnswer: 12,
      options: [11, 12, 13],
    },
    {
      ...
      instruction: "¡Encuentra la señal diferente!",
      items: ["🚦", "🚦", "🛑", "🚦"],
      correctAnswer: 2,
      options: [0, 1, 2, 3],
    },
    {
      title: "Vehículos de la Ciudad",
      instruction: "¡Toca el vehículo que no pertenece!",
      items: ["🚕", "🚌", "🚁", "🚗"],
      correctAnswer: 2,
      options: [0, 1, 2, 3],
    },
    {
      title: "Suma de Autobuses",
      instruction: "¿Cuántos autobuses hay en la parada?",
      items: ["🚌", "🚌", "🚌", "🚌", "🚌", "🚌", "🚌", "🚌", "🚌", "🚌", "🚌", "🚌", "🚌"],
      correctAnswer: 13,
      options: [12, 13, 14],
    },
    {
      title: "Secuencia de Tráfico",
      instruction: "¿Qué sigue en la secuencia?",
      items: ["🚗", "🚕", "🚗", "🚕", "🚗", "?"],
      correctAnswer: 1,
      options: [0, 1, 2],
    },
      ...
      case 4:
        return (
          <div className="space-y-6">
            <div className="flex justify-center gap-2 text-3xl flex-wrap">
    ...
    <Card className="w-full bg-white/90 backdrop-blur-sm">
      <CardContent className="p-8">
        <div className="text-center space-y-6">
          <h2 className="text-3xl font-bold text-indigo-600 mb-4">{currentGame.title}</h2>
